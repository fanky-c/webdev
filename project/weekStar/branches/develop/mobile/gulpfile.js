...
gulp.task('watch', function() {
    ...
    // 看守所有.scss档
    gulp.watch([path.joinFormat(__dirname, iConfig.src, '**/*.scss'),
                path.joinFormat(__dirname, iConfig.src, 'components/*.scss'),
                path.joinFormat(__dirname, iConfig.src, 'sass/*.scss')], ['css']);
